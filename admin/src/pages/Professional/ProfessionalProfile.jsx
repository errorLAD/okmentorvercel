...
const ProfessionalProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(ProfessionalContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/professional/update-profile', updateData, { headers: { dToken } })
        ...
        <div>
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    {/* -----professional Info : name, degree, experience ----- */}
